	...
	<body>
		...
		<?php
			...
			if (!empty($_POST)) {
				...
				$result = mysql_query("UPDATE user SET address='$add' WHERE username='$nev3'");
		...
		?>
		<div class="container">
			<h1>Changing Address: </h1><br>
			<form method="post">
				<div class="form-group">
					<div class="row">
						<div class="col-md-4">
							<input type="text" name="add" class="form-control" id="add" placeholder="Enter Your New Address"/> <br>
							<input type="submit" value="Change Address" class="btn btn-primary btn-lg  login-button" /><br><br>
