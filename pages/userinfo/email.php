	...
	<body>
		...
		<?php
			...
			if (!empty($_POST)) {
				...
				$result = mysql_query("UPDATE user SET email='$email' WHERE username='$nev3'");
		...
		?>
		<div class="container">
			<h1>Changing E-mail: </h1><br>
			<form method="post">
				<div class="form-group">
					<div class="row">
						<div class="col-md-4">
							<input type="text" name="email" class="form-control" id="email" placeholder="Enter Your New E-mail"/> <br>
							<input type="submit" value="Change E-mail" class="btn btn-primary btn-lg  login-button" /><br><br>
