	...
	<body>
		...
		<?php
			...
			if (!empty($_POST)) {
				...
				$hash_pwd = sha1($pw);
				$result = mysql_query("UPDATE user SET password='$hash_pwd' WHERE username='$nev3'");
		...
		<div class="container">
			...
			<form method="post">
				<div class="form-group">
					<div class="row">
						<div class="col-md-4">
							<input type="password" name="pw" class="form-control" id="pw" placeholder="Enter Your New Password"/> <br>
							<input type="submit" value="Change Password" class="btn btn-primary btn-lg  login-button" /><br><br>
